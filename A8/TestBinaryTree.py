...
#  Description: This program takes in a list and turn it into a binary tree. There are functions that can return the range of the list, a specific level of the binary tree, left side view of the binary tree, and sum
#               of all leaf nodes. 
...
class Tree(object):
    ...
    # Returns the list of the node that you see from left sides
